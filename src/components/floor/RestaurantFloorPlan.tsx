...
const RestaurantFloorPlan: React.FC = () => {
    ...
    const handleDragStart = (e: MouseEvent<HTMLDivElement>, table: Table): void => {
    ...
    const handleTableClick = (e: MouseEvent<HTMLDivElement>, table: Table): void => {
        e.stopPropagation();
        ...
        <div className="flex flex-col w-full max-w-6xl mx-auto p-4">
            ...
            >
                <div className="absolute top-2 left-2 text-gray-400">
                    {isAdminMode ? 'Click to add a table, drag to move' : 'Click on a table to make a reservation'}
                </div>
            ...
            <div className="mt-4 text-sm text-gray-500">
                {isAdminMode ? (
                    <div>Admin mode: Create and position tables by clicking and dragging</div>
                ) : (
